...
import com.faceunity.nama.utils.device.DeviceScoreUtils;
...
public class FuDeviceUtils {
    ...
    public static HashMap<String, ArrayList<String>> getBlackListMap() {
        String blackList = FileUtils.loadStringFromLocal(FUApplication.getApplication(), FUConfig.BLACK_LIST);
        Gson gson = new Gson();
